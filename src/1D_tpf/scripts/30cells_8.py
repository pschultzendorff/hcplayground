...
results_dir = pathlib.Path(__file__).parent / "30cells_8_results"
...
model_diffhc1 = DiffusionHC4CoreyRelPerms(**model_params, fixed_diffusion_coeff=1e-5)
model_diffhc2 = DiffusionHC4CoreyRelPerms(**model_params, fixed_diffusion_coeff=1e-3)
model_diffhc3 = DiffusionHC4CoreyRelPerms(**model_params, fixed_diffusion_coeff=1)
