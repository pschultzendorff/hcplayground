...
results_dir = pathlib.Path(__file__).parent / "30cells_3_results"
...
solutions, _ = solve(model, final_time=0.01, n_time_steps=1)
...
for p_e in [0.05, 2.0, 10.0, 50]:
    ...
    model_fluxhc4 = FluxHC4(**model_params, p_e=p_e, k=3.0)
    model_fluxhc5 = FluxHC5(**model_params, p_e=p_e, k=1.0)
    model_fluxhc6 = FluxHC5(**model_params, p_e=p_e, k=10.0)
