"""Implicit finite volume model for the hyperbolic conservation law, in particular for
...
The hyperbolic conservation law, derived from the two-phase flow equation in porous
media, is solved for saturation.
...
class TPFModel:
    ...
    def compute_face_fluxes(self, s):
        ...
        Args:
            s: Saturations at cell centers [s0, s1].
